...
public interface EmoState extends Library {
    ...
    //! Create com.emotiv.epoc.EmoState handle.
    	/*!
            NOTE: THIS FUNCTION HAS BEEN DEPRECATED - please use EE_EmoStateCreate instead.

    		ES_Init is called automatically after the creation of the com.emotiv.epoc.EmoState handle.
    		ES_Free must be called to free up resources during the creation of the com.emotiv.epoc.EmoState handle.
    ...
    //! Free com.emotiv.epoc.EmoState handle
    	/*!
    ...
    //! Initialize the com.emotiv.epoc.EmoState into neutral state
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is blinking at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is winking left at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is winking right at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the eyes of the user are opened at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is looking up at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is looking down at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - Pointer
    ...
    //! Query whether the user is looking left at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - EmoStatehandle
    ...
    //! Query whether the user is looking right at the time the com.emotiv.epoc.EmoState is captured.
    	/*!
    		\param state - EmoStatehandle
