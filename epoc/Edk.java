...
public interface Edk extends Library {
    ...
    //! Returns a handle to memory that can store an com.emotiv.epoc.EmoState. This handle can be reused by the caller to retrieve subsequent EmoStates.
    	/*!
    		\return Pointer
    	*/
    Pointer
    ...
    //! Frees memory referenced by an com.emotiv.epoc.EmoState handle.
    	/*!
    ...
    //! Copies an com.emotiv.epoc.EmoState returned with a EE_EmoStateUpdate event to memory referenced by an Pointer.
    	/*!
